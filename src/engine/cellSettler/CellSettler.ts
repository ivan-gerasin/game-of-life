...
export default class CellSettler<F extends ICellFactory<F, C>, C extends ICell<F,C>> implements ICellSettler<F,C> {
  constructor(private readonly symbolToCellMapper: ISymbolToCellMapper<F,C>){}

  settle(world: IWorld<F,C>, preset: Preset) {
