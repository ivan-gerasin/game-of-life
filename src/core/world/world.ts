...
import {IPoint, IRealPoint, Point} from 'core/point'
...
> implements IWorld<FactoryType, CellType> {
	...
	private findCellPosition(cell: CellType): IPoint {
	...
	boundaryPolicy(coordinate: ICoordinate): CellType {
		return this.cellFactory.empty()
	}

	isValueOutOfBound(pos: number): boolean {
